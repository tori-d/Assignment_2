...
In order to analyse the relationship between youth unemployment and the political engagement of youth, we can make use of the variables under the ESS theme Politics that capture multiple aspects of an individual's political participation and hence, are suitable for our analysis. While variables measuring respondents' voting in the last election, participation in a political party, participation in campaigns or demonstrations, etc., reflect the actual involvement of the respondents in the political process, other variables measure interest in politcs, ease of comprehending political issues, and trust in political institutions. The latter give us an understanding of a different dimension of the citizenry's political engagement. The ideological stance of the respondents is also measured through variables like placement on left-right scale, opinion on health services, education services, homosexuality,immigration, European unification etc. This gives us further substantive data to add to our analysis.
...
The actual data analysis would involve basic descriptive statistics to give a general overview of how both the youth unemployment rate and the various political participation variables vary across countries. We would also likely select a few key countries to show how both the unemployment rate and youth political particpation have changed over time in a single country. Finally, we will likely explore some sort of regression to see what sort of relationship, if any, can be established between the unemployment rate and youth political participation. 
